...
class UnityAcademyDetails extends StatelessWidget {
  final UnityTask unitytask;
  const UnityAcademyDetails({super.key, required this.unitytask});
                        ...
                        child: PhysicalModel(
                          ...
                          child: Container(
                            ...
                            child: Center(
                                child: Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Text(unitytask.task2,textAlign: TextAlign.center,),
                            )),
                          ),
                        ),
                      )
